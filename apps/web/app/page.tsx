...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 font-primary flex flex-col items-center justify-center text-zinc-100 p-4">
      ...
      <div className="max-w-xl w-full text-center space-y-8">
        <div className="space-y-2">
            <h1 className="text-8xl font-bold font-cta tracking-tighter bg-clip-text text-white">
              Spawn
            </h1>
        ...
        <ShimmerButton
          ...
          className="px-8 py-3 rounded-full font-medium transition-all flex items-center gap-2 mx-auto disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
