...
import { File, getFiles, startSandbox } from "../../../lib/api"; // Check your import path
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-zinc-950 text-zinc-100 font-sans">
      <ResizablePanelGroup direction="horizontal">
        ...
        {/* LEFT PANEL: CHAT */}
        <ResizablePanel defaultSize={25} minSize={20} className="border-r border-zinc-800">
          <Chat
            projectId={id}
              ...
              <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20">
                <div className="bg-zinc-900/80 backdrop-blur-md border border-zinc-800 rounded-full shadow-xl">
                  <ToggleGroup
                    type="single"
                    value={activeTab}
                    onValueChange={(value) => value && setActiveTab(value as "preview" | "code")}
                    className="flex"
                  >
                    <ToggleGroupItem 
                      value="preview" 
